...
public class SimulationOneNeoMultipleVotes {

	// Configuration
	static int totalNEO = 100000000;
	static float neoConsortiumHoldings = 0.45f; // NEO holdings
	static float economicConsortiumHoldings = 0.20f; // Economic holdings
	...
	static File saveFile = new File("C:\\Users\\malco\\Desktop\\simulation_N45_E20.csv");
	...
	private static void writeVoteResult(ArrayList<Nominee> consensusNodes, int neoNominees, int economicNominees) {
		...
		try {
			...
			float economicNodeNeoSupport = (economicConsortiumHoldings * totalNEO);
